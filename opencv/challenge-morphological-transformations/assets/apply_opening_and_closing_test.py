...
class TestMorphologicalTransformations(unittest.TestCase):
    ...
    def test_apply_opening_and_closing(self):
        ...
        kernel_shape, kernel_size, opening_iterations, closing_iterations = "rectangular", 3, 2, 2
        processed_image = apply_opening_and_closing(image, kernel_shape, kernel_size, opening_iterations, closing_iterations)
