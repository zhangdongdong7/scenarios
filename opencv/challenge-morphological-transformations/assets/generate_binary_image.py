...
# # Generate a binary image and save it
## You can use the generated images in the next challenges.
# result = generate_binary_image(600, 800, 200)
# cv2.imwrite("img1.jpg",result)