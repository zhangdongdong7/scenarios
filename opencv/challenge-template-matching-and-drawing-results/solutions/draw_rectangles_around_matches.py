...
def draw_rectangles_around_matches(source_image: cv2.Mat, template_image: cv2.Mat, best_matches: Dict[str, Tuple[float, Tuple[int, int]]]) -> Tuple[np.ndarray]:
    ...
    source_with_rectangles1 = cv2.rectangle(source_image.copy(), top_left1, bottom_right1, colors[method1], 2)
    source_with_rectangles2 = cv2.rectangle(source_image.copy(), top_left2, bottom_right2, colors[method2], 2)
    source_with_rectangles3 = cv2.rectangle(source_image.copy(), top_left3, bottom_right3, colors[method3], 2)
