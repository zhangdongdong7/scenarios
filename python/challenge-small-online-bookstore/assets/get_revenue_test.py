...
class TestBookstore(unittest.TestCase):
    def setUp(self):
        ...
        # create tables
        self.cursor.execute('CREATE TABLE books (id INTEGER PRIMARY KEY, title TEXT, author TEXT, price REAL)')
        self.cursor.execute('CREATE TABLE orders (id INTEGER PRIMARY KEY, book_id INTEGER, quantity INTEGER, order_date TEXT)')
    ...
    def test_get_revenue(self):
        ...
        self.assertAlmostEqual(get_revenue(self.cursor, '2023-02-21', '2023-02-22'), 70.95)
