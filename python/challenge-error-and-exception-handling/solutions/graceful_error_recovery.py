...
from custom_exceptions_and_logging import logging, read_data_from_file, FileNotFoundError, InvalidDataError, OperationFailedError
    ...
    def wrapper(*args, **kwargs):
        ...
        while retries < max_retries:
            try:
                ...
                logging.warning(f"Operation failed. Retrying in {wait_time} seconds. Error: {str(e)}")
