...
from custom_exceptions_and_logging import read_data_from_file, process_data, FileNotFoundError, InvalidDataError, OperationFailedError
    ...
    def test_perform_critical_operation_success(self):
        with patch('time.sleep'):
            try:
                ...
                self.fail("perform_critical_operation() raised OperationFailedError unexpectedly.")
