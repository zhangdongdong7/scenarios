...
class TestCalculateRevenueTotals(unittest.TestCase):
    ...
    def test_calculate_revenue_totals(self):
        ...
        np.testing.assert_array_equal(total_revenue_by_customer, expected_total_revenue_by_customer)
        np.testing.assert_array_equal(total_revenue_by_product, expected_total_revenue_by_product)
