...
class TestRounding(unittest.TestCase):
    ...
    def test_rounding(self):
        ...
        rounded_average_purchases_per_customer = round_values(average_purchases_per_customer, 2)
        rounded_average_purchases_per_product = round_values(average_purchases_per_product, 2)
