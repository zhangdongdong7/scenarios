...
class TestCalculateAveragePurchases(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.transactions = np.array([[1, 2, 3],
                                    [0, 1, 0],
                                    [4, 0, 2]])
        
        # Calculate the total number of purchases by customer and by product
        self.total_purchases_by_customer, self.total_purchases_by_product = calculate_purchase_totals(self.transactions)

    def test_average_purchases_per_customer(self):
        # Calculate the average number of purchases per customer
        average_purchases_per_customer = calculate_average_purchases(self.total_purchases_by_customer)
    ...
    def test_average_purchases_per_product(self):
        ...
        average_purchases_per_product = calculate_average_purchases(self.total_purchases_by_product)
